	...
	do
		do -- Elements
			...
			do -- Title
				...
				do -- Text
					ReadableUIFrame.Title.Text = addon.API.FrameTemplates:CreateText(ReadableUIFrame.Title, addon.Theme.RGB_WHITE, 22.5, "CENTER", "TOP", GameFontNormal:GetFont(), "$parent.Text")
				...
				do -- Current page text
					ReadableUIFrame.Title.CurrentPageText = addon.API.FrameTemplates:CreateText(ReadableUIFrame.Title, addon.Theme.RGB_WHITE, 15, "CENTER", "MIDDLE", GameFontNormal:GetFont(), "$parent.CurrentPageText")
			...
			do -- Navigation
				...
				do -- Buttons
					...
					do -- Previous page
						ReadableUIFrame.NavigationFrame.PreviousPage = CreateButton(150 * .14, 150, -1, NS.Variables.READABLE_UI_PATH .. "Elements\\BackButton.png", NS.Variables.READABLE_UI_PATH .. "Elements\\BackButton.png", function() InteractionReadableUIFrame:Back() end)
						ReadableUIFrame.NavigationFrame.PreviousPage:SetPoint("LEFT", ReadableUIFrame, 55, 0)
					end

					do -- Next page
						ReadableUIFrame.NavigationFrame.NextPage = CreateButton(150 * .14, 150, 1, NS.Variables.READABLE_UI_PATH .. "Elements\\NextButton.png", NS.Variables.READABLE_UI_PATH .. "Elements\\NextButton.png", function() InteractionReadableUIFrame.Next() end)
			...
			do -- Item ui
				...
				do -- Text
					...
					function ReadableUIFrame.ItemFrame.ScrollFrame.MouseWheel()
					...
					do -- Text
						do -- Measurement
							ReadableUIFrame.ItemFrame.ScrollFrame.MeasurementText = addon.API.FrameTemplates:CreateText(ReadableUIFrame.ItemFrame.ScrollFrame, addon.Theme.RGB_BLACK, TEXT_SIZE_ITEM, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.MeasurementText", true)
							ReadableUIFrame.ItemFrame.ScrollFrame.MeasurementText.Text:SetWidth(ReadableUIFrame.ItemFrame.ScrollFrame:GetWidth())
							ReadableUIFrame.ItemFrame.ScrollFrame.MeasurementText:SetAlpha(0)
						end

						do -- Text
							ReadableUIFrame.ItemFrame.ScrollFrame.Text = addon.API.FrameTemplates:CreateText(ReadableUIFrame.ItemFrame.ScrollChild, addon.Theme.RGB_BLACK, addon.Database.DB_GLOBAL.profile.INT_CONTENT_SIZE, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.Text", true)
							ReadableUIFrame.ItemFrame.ScrollFrame.Text.Text:SetSize(ReadableUIFrame.ItemFrame.ScrollChild:GetWidth(), 5000)
							ReadableUIFrame.ItemFrame.ScrollFrame.Text.Text:SetPoint("TOP", ReadableUIFrame.ItemFrame.ScrollChild)
						end

						hooksecurefunc(ReadableUIFrame.ItemFrame.ScrollFrame.Text.Text, "SetText", function()
							C_Timer.After(.1, function()
								local StringHeight

								ReadableUIFrame.ItemFrame.ScrollFrame:SetVerticalScroll(0)

								ReadableUIFrame.ItemFrame.ScrollFrame.MeasurementText.Text:SetText(ReadableUIFrame.ItemFrame.ScrollFrame.Text.Text:GetText())
								StringHeight = ReadableUIFrame.ItemFrame.ScrollFrame.MeasurementText.Text:GetStringHeight()

								ReadableUIFrame.ItemFrame.ScrollChild:SetHeight(StringHeight + 50)
								ReadableUIFrame.ItemFrame.ScrollFrame.Text.Text:SetHeight(StringHeight + 50)
			...
			do -- Book ui
				...
				do -- Front page
					...
					do -- Background
						ReadableUIFrame.BookFrame.FrontPage.Background, ReadableUIFrame.BookFrame.FrontPage.BackgroundTexture = addon.API.FrameTemplates:CreateTexture(ReadableUIFrame.BookFrame.FrontPage, "FULLSCREEN", NS.Variables.READABLE_UI_PATH .. "Book\\BookCover.png", "$parent.Background")
					...
					do -- Text
						...
						do -- Title
							ReadableUIFrame.BookFrame.FrontPage.Text.Title = addon.API.FrameTemplates:CreateText(ReadableUIFrame.BookFrame.FrontPage.Text, addon.Theme.RGB_WHITE, 25, "CENTER", "MIDDLE", GameFontNormal:GetFont(), "$parent.Text")
					...
					do -- Text
						...
						do -- Left
							...
							function ReadableUIFrame.BookFrame.Content.Left:UpdateScrollIndicator()
								if NS.ItemUI.Variables.Type == "ParchmentLarge" then
									ReadableUIFrame.BookFrame.Content.Left.GradientTexture:SetTexture(NS.Variables.READABLE_UI_PATH .. "Book\\BookLargeContentFade.png")
								else
									ReadableUIFrame.BookFrame.Content.Left.GradientTexture:SetTexture(NS.Variables.READABLE_UI_PATH .. "Book\\BookContentFade.png")
								end
							...
							do -- Gradient
								ReadableUIFrame.BookFrame.Content.Left.Gradient, ReadableUIFrame.BookFrame.Content.Left.GradientTexture = addon.API.FrameTemplates:CreateTexture(ReadableUIFrame.BookFrame.Content.Left, "FULLSCREEN", NS.Variables.READABLE_UI_PATH .. "Book\\BookLargeContentFade.png", "$parent.Gradient")
							...
							do -- Text
								do -- Measurement
									ReadableUIFrame.BookFrame.Content.Left.MeasurementText = addon.API.FrameTemplates:CreateText(ReadableUIFrame.BookFrame.Content.Left, addon.Theme.RGB_BLACK, TEXT_SIZE_BOOK, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.MeasurementText", true)
									ReadableUIFrame.BookFrame.Content.Left.MeasurementText.Text:SetWidth(ReadableUIFrame.BookFrame.Content.Left:GetWidth())
									ReadableUIFrame.BookFrame.Content.Left.MeasurementText:SetAlpha(0)
								end

								do -- Text
									ReadableUIFrame.BookFrame.Content.Left.Text = addon.API.FrameTemplates:CreateText(ReadableUIFrame.BookFrame.Content.LeftScrollChild, addon.Theme.RGB_BLACK, TEXT_SIZE_BOOK, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.Text", true)
									ReadableUIFrame.BookFrame.Content.Left.Text.Text:SetSize(ReadableUIFrame.BookFrame.Content.LeftScrollChild:GetWidth(), ReadableUIFrame.BookFrame.Content.LeftScrollChild:GetHeight())
									ReadableUIFrame.BookFrame.Content.Left.Text.Text:SetPoint("TOP", ReadableUIFrame.BookFrame.Content.LeftScrollChild)

									hooksecurefunc(ReadableUIFrame.BookFrame.Content.Left.Text.Text, "SetText", function()
										C_Timer.After(.1, function()
											local StringHeight
											...
											if NS.ItemUI.Variables.Type ~= "ParchmentLarge" then
												ReadableUIFrame.BookFrame.Content.Left.MeasurementText.Text:SetText(ReadableUIFrame.BookFrame.Content.Left.Text.Text:GetText())
												StringHeight = ReadableUIFrame.BookFrame.Content.Left.MeasurementText.Text:GetStringHeight()
											else
												StringHeight = ReadableUIFrame.BookFrame.Content.Left.Text.Text:GetStringHeight()
											end

											ReadableUIFrame.BookFrame.Content.LeftScrollChild:SetHeight(StringHeight + 50)
											ReadableUIFrame.BookFrame.Content.Left.Text.Text:SetHeight(StringHeight + 50)
							...
							do -- Footer
								ReadableUIFrame.BookFrame.Content.Left.Footer = addon.API.FrameTemplates:CreateText(ReadableUIFrame.BookFrame.Content.Left, addon.Theme.RGB_BLACK, 10, "LEFT", "BOTTOM", GameFontNormal:GetFont(), "$parent.Footer")
						...
						do -- Right
							...
							function ReadableUIFrame.BookFrame.Content.Right:UpdateScrollIndicator()
								if NS.ItemUI.Variables.Type == "ParchmentLarge" then
									ReadableUIFrame.BookFrame.Content.Right.GradientTexture:SetTexture(NS.Variables.READABLE_UI_PATH .. "Book\\BookLargeContentFade.png")
								else
									ReadableUIFrame.BookFrame.Content.Right.GradientTexture:SetTexture(NS.Variables.READABLE_UI_PATH .. "Book\\BookContentFade.png")
								end
							...
							do -- Gradient
								ReadableUIFrame.BookFrame.Content.Right.Gradient, ReadableUIFrame.BookFrame.Content.Right.GradientTexture = addon.API.FrameTemplates:CreateTexture(ReadableUIFrame.BookFrame.Content.Right, "FULLSCREEN", NS.Variables.READABLE_UI_PATH .. "Book\\BookLargeContentFade.png", "$parent.Gradient")
							...
							do -- Text
								do -- Measurement
									ReadableUIFrame.BookFrame.Content.Right.MeasurementText = addon.API.FrameTemplates:CreateText(ReadableUIFrame.BookFrame.Content.Right, addon.Theme.RGB_BLACK, TEXT_SIZE_BOOK, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.MeasurementText", true)
									ReadableUIFrame.BookFrame.Content.Right.MeasurementText.Text:SetWidth(ReadableUIFrame.BookFrame.Content.Right:GetWidth())
									ReadableUIFrame.BookFrame.Content.Right.MeasurementText:SetAlpha(0)
								end

								do -- Text
									ReadableUIFrame.BookFrame.Content.Right.Text = addon.API.FrameTemplates:CreateText(ReadableUIFrame.BookFrame.Content.RightScrollChild, addon.Theme.RGB_BLACK, TEXT_SIZE_BOOK, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.Text", true)
									ReadableUIFrame.BookFrame.Content.Right.Text.Text:SetSize(ReadableUIFrame.BookFrame.Content.Right:GetWidth(), ReadableUIFrame.BookFrame.Content.Right:GetHeight())
									ReadableUIFrame.BookFrame.Content.Right.Text.Text:SetPoint("TOP", ReadableUIFrame.BookFrame.Content.RightScrollChild)

									hooksecurefunc(ReadableUIFrame.BookFrame.Content.Right.Text.Text, "SetText", function()
										C_Timer.After(.1, function()
											local StringHeight
											...
											if NS.ItemUI.Variables.Type ~= "ParchmentLarge" then
												ReadableUIFrame.BookFrame.Content.Right.MeasurementText.Text:SetText(ReadableUIFrame.BookFrame.Content.Right.Text.Text:GetText())
												StringHeight = ReadableUIFrame.BookFrame.Content.Right.MeasurementText.Text:GetStringHeight()
											else
												StringHeight = ReadableUIFrame.BookFrame.Content.Right.Text.Text:GetStringHeight()
											end

											ReadableUIFrame.BookFrame.Content.RightScrollChild:SetHeight(StringHeight + 5)
											ReadableUIFrame.BookFrame.Content.Right.Text.Text:SetHeight(StringHeight + 5)
							...
							do -- Footer
								ReadableUIFrame.BookFrame.Content.Right.Footer = addon.API.FrameTemplates:CreateText(ReadableUIFrame.BookFrame.Content.Right, addon.Theme.RGB_BLACK, 10, "RIGHT", "BOTTOM", GameFontNormal:GetFont(), "$parent.Footer")
