					...
					TemplateRegistry:Add("Readable.LibraryUI.SideBar.Tab.Frame", function(parent, frameStrata, frameLevel, name)
						...
						do -- Elements
							do -- Content
								...
								do -- Background
									Content.Background, Content.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Content, frameStrata, NS.Variables.READABLE_UI_PATH .. "Library\\TabBackground.png", 79, .075, "$parent.Background")
						...
						TemplateRegistry:Add("Readable.LibraryUI.SideBar.Tab.Template.Button", function(parent, tab, buttonIndex, frameStrata, frameLevel, name)
							...
							do -- Elements
								do -- Content
									...
									do -- Background
										Content.Background, Content.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Content, frameStrata, NS.Variables.READABLE_UI_PATH .. "Library\\TabBackgroundHighlighted.png", 79, .0375, "$parent.Background")
										Content.Background:SetPoint("TOPLEFT", Content, 0, 0)
										Content.Background:SetPoint("BOTTOMRIGHT", Content, 0, 0)
										Content.Background:SetFrameStrata(frameStrata)
										Content.Background:SetFrameLevel(frameLevel + 1)
