	...
	do
				...
				do -- Buttons
					...
					for i = 1, #Entries do
						...
						local ItemParchmentTexture; if addon.Theme.IsDarkTheme then
							ItemParchmentTexture = NS.Variables.READABLE_UI_PATH .. "Library\\Parchment-Dark.png"
						else
							ItemParchmentTexture = NS.Variables.READABLE_UI_PATH .. "Library\\Parchment-Light.png"
						end
						local ItemStoneTexture = NS.Variables.READABLE_UI_PATH .. "Library\\Slate.png"
						local ItemBookTexture = NS.Variables.READABLE_UI_PATH .. "Library\\Book.png"
						local ItemBookLargeTexture = NS.Variables.READABLE_UI_PATH .. "Library\\BookLarge.png"
		...
		do -- Data
			...
			function LibraryCallback:Export()
				...
				local copyIcon = isMacClient and addon.Variables.PATH_ART .. "Platform\\PC-Copy-Mac.png" or addon.Variables.PATH_ART .. "Platform\\PC-Copy-Windows.png"
