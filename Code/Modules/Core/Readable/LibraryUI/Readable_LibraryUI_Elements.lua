...
function NS.LibraryUI.Elements:Load()
	...
	do
		do -- Elements
			...
			do -- Background
				LibraryUIFrame.Background, LibraryUIFrame.BackgroundTexture = addon.API.FrameTemplates:CreateTexture(LibraryUIFrame, "FULLSCREEN", NS.Variables.READABLE_UI_PATH .. "Library\\LibraryBackground.png", "$parent.Background")
			...
			do -- Content
				...
				do -- Title
					...
					do -- Main
						...
						do -- Text
							...
							LibraryUIFrame.Content.Title.Main.Text = addon.API.FrameTemplates:CreateText(LibraryUIFrame.Content.Title.Main, addon.Theme.RGB_WHITE, 30, "CENTER", "MIDDLE", GameFontNormal:GetFont(), "$parent.Text")
						...
						do -- Subtext
							...
							LibraryUIFrame.Content.Title.Main.Subtext = addon.API.FrameTemplates:CreateText(LibraryUIFrame.Content.Title.Main, addon.Theme.RGB_WHITE, 12.5, "CENTER", "MIDDLE", GameFontNormal:GetFont(), "$parent.Subtext")
					...
					do -- Divider
						LibraryUIFrame.Content.Title.Divider, LibraryUIFrame.Content.Title.DividerTexture = addon.API.FrameTemplates:CreateTexture(LibraryUIFrame.Content.Title, "FULLSCREEN", NS.Variables.READABLE_UI_PATH .. "Library\\DividerTitle.png", "$parent.Divider")
				...
				do -- Sidebar
					...
					do -- Tab
						LibraryUIFrame.Content.Sidebar.Tab = TemplateRegistry:Create("Readable.LibraryUI.SideBar.Tab.Frame", LibraryUIFrame.Content.Sidebar, "FULLSCREEN", 3, "$parent.Tab")
						...
						do -- Layout group
							...
							do -- Elements
								do -- Button (CHARACTER)
									...
									LayoutGroup.Button_Local = TemplateRegistry:Create("Readable.LibraryUI.SideBar.Tab.Button.Image", LayoutGroup, Tab, 1, "FULLSCREEN", 4, "$parent.Button_Local")
								...
								do -- Button (WARBAND)
									...
									LayoutGroup.Button_Global = TemplateRegistry:Create("Readable.LibraryUI.SideBar.Tab.Button.Image", LayoutGroup, Tab, 2, "FULLSCREEN", 4, "$parent.Button_Global")
					...
					do -- Search
						...
						LibraryUIFrame.Content.Sidebar.Search = addon.API.FrameTemplates:CreateInputBox(LibraryUIFrame.Content.Sidebar, "FULLSCREEN", LibraryUIFrame.Content.Sidebar:GetFrameLevel() + 1, {
							defaultTexture = NS.Variables.TEXTURE_RUSTIC_BORDER,
							highlightTexture = NS.Variables.TEXTURE_RUSTIC,
							edgeSize = 128,
							scale = .075,
					...
					do -- Categories
						local function CreateCheckbox(callback, text, name)
							local Frame = TemplateRegistry:Create("Readable.LibraryUI.SideBar.Categories.Checkbox", LibraryUIFrame.Content.Sidebar, callback, text, "FULLSCREEN", 3, name)
						...
						do -- Label (SHOW)
							LibraryUIFrame.Content.Sidebar.Label_Show = addon.API.FrameTemplates:CreateText(LibraryUIFrame.Content.Sidebar, addon.Theme.RGB_WHITE, 12.5, "LEFT", "MIDDLE", GameFontNormal:GetFont(), "$parent.Label_Show")
					...
					do -- Buttons
						...
						addon.SoundEffects:SetButton(LibraryUIFrame.Content.Sidebar.Button_Export)
						...
						addon.SoundEffects:SetButton(LibraryUIFrame.Content.Sidebar.Button_Import)
					end
				end

				do -- Divider
					LibraryUIFrame.Content.Divider, LibraryUIFrame.Content.DividerTexture = addon.API.FrameTemplates:CreateTexture(LibraryUIFrame.Content, "FULLSCREEN", NS.Variables.READABLE_UI_PATH .. "Library\\DividerSidebar.png", "$parent.Divider")
				...
				do -- Content
					...
					do -- Index frame
						...
						do -- Background
							LibraryUIFrame.Content.ContentFrame.Index.Background, LibraryUIFrame.Content.ContentFrame.Index.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(LibraryUIFrame.Content.ContentFrame.Index, "FULLSCREEN", NS.Variables.READABLE_UI_PATH .. "Library\\index-background-.png", 64, .25, "$parent.Background")
						...
						do -- Content
							...
							do -- Text
								LibraryUIFrame.Content.ContentFrame.Index.Content.Text = addon.API.FrameTemplates:CreateText(LibraryUIFrame.Content.ContentFrame.Index.Content, addon.Theme.RGB_WHITE, 15, "CENTER", "MIDDLE", GameFontNormal:GetFont(), "$parent.Text")
							...
							do -- Buttons
								do -- Previous page
									...
									addon.SoundEffects:SetButton(LibraryUIFrame.Content.ContentFrame.Index.Content.Button_PreviousPage)
								...
								do -- Next page
									...
									addon.SoundEffects:SetButton(LibraryUIFrame.Content.ContentFrame.Index.Content.Button_NextPage)
					...
					do -- Content frame
						do -- Scroll frame
							...
							do -- Elements
								...
								do -- Label
									LibraryUIFrame.Content.ContentFrame.ScrollFrame.Label = addon.API.FrameTemplates:CreateText(LibraryUIFrame.Content.ContentFrame.ScrollFrame, addon.Theme.RGB_WHITE, 20, "CENTER", "MIDDLE", GameFontNormal:GetFont(), "$parent.Label")
							...
							local function CreateButton(parent, index)
								...
								do -- Elements
									do -- Content
										...
										do -- Background
											Frame.Content.Background, Frame.Content.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Frame.Content, "FULLSCREEN", NS.Variables.READABLE_UI_PATH .. "Library\\ElementBackground.png", 64, .75, "$parent.Background", Enum.UITextureSliceMode.Stretched)
										...
										do -- Text
											...
											do -- Detail
												Frame.Content.Text.Detail = addon.API.FrameTemplates:CreateText(Frame.Content.Text, addon.Theme.RGB_WHITE, 10, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.Detail")
											...
											do -- Title
												Frame.Content.Text.Title = addon.API.FrameTemplates:CreateText(Frame.Content.Text, addon.Theme.RGB_WHITE, 15, "LEFT", "BOTTOM", GameFontNormal:GetFont(), "$parent.Title")
										...
										do -- Buttons
											...
											do -- Open
												Frame.Content.ButtonContainer.Button_Open = addon.API.FrameTemplates:CreateCustomButton(Frame.Content.ButtonContainer, buttonSize, buttonSize, "FULLSCREEN", {
													defaultTexture = NS.Variables.READABLE_UI_PATH .. "Library\\ButtonBackground.png",
													highlightTexture = NS.Variables.READABLE_UI_PATH .. "Library\\ButtonBackgroundHighlighted.png",
													theme = 2,
													edgeSize = 64,
													scale = 5,
													texturePadding = 12.5,
												...
												do -- Image
													Frame.Content.ButtonContainer.Button_Open.Image, Frame.Content.ButtonContainer.Button_Open.ImageTexture = addon.API.FrameTemplates:CreateTexture(Frame.Content.ButtonContainer.Button_Open, "FULLSCREEN", NS.Variables.READABLE_UI_PATH .. "Library\\OpenButton.png", "$parent.Image")
											...
											do -- Delete
												...
												do -- Image
													Frame.Content.ButtonContainer.Button_Delete.Image, Frame.Content.ButtonContainer.Button_Delete.ImageTexture = addon.API.FrameTemplates:CreateTexture(Frame.Content.ButtonContainer.Button_Delete, "FULLSCREEN", NS.Variables.READABLE_UI_PATH .. "Library\\DeleteButton.png", "$parent.Image")
								...
								do -- Animations
									do -- On enter
										...
										function Frame:Animation_OnEnter(skipAnimation)
											Frame:SetAlpha(.925)
											Frame.Content.Background:SetAlpha(1)
											Frame.Content.BackgroundTexture:SetTexture(NS.Variables.READABLE_UI_PATH .. "Library\\ElementBackgroundHighlighted.png")
									...
									function Frame:Animation_OnLeave(skipAnimation)
										Frame:SetAlpha(.75)
										Frame.Content.Background:SetAlpha(1)
										Frame.Content.BackgroundTexture:SetTexture(NS.Variables.READABLE_UI_PATH .. "Library\\ElementBackground.png")
