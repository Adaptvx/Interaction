...
function NS.Script:Load()
	...
	local function RefreshBlizzardTooltipParent()
		local useBlizzardTooltip = addon.Database.DB_GLOBAL and addon.Database.DB_GLOBAL.profile.INT_BLIZZARD_TOOLTIP
		local parent = (useBlizzardTooltip and (InteractionPriorityFrame or InteractionFrame)) or UIParent
		local ignoreParentAlpha = useBlizzardTooltip and true or false

		GameTooltip:SetParent(parent)
		GameTooltip:SetIgnoreParentAlpha(ignoreParentAlpha)

		local shoppingTooltips = rawget(GameTooltip, "shoppingTooltips")
		if shoppingTooltips then
			for _, shoppingTooltip in ipairs(shoppingTooltips) do
				shoppingTooltip:SetParent(parent)
				shoppingTooltip:SetIgnoreParentAlpha(ignoreParentAlpha)
			end
		end
	end
	...
	do
		CallbackRegistry:Add("SETTING_BLIZZARD_TOOLTIP_CHANGED", RefreshBlizzardTooltipParent)
		CallbackRegistry:Add("START_HIDEUI", RefreshBlizzardTooltipParent)
		CallbackRegistry:Add("STOP_HIDEUI", RefreshBlizzardTooltipParent)
