	...
	do
		do -- Elements
			...
			do -- Style
				...
				StyleTooltip(InteractionFrame.GameTooltip, addon.API.Presets.TEXTURE_TOOLTIP_CUSTOM_LIGHT, 1)
				StyleTooltip(InteractionFrame.ShoppingTooltip1, addon.API.Presets.TEXTURE_TOOLTIP_CUSTOM_LIGHT, .75)
				StyleTooltip(InteractionFrame.ShoppingTooltip2, addon.API.Presets.TEXTURE_TOOLTIP_CUSTOM_LIGHT, .75)
			end
		end
	end
