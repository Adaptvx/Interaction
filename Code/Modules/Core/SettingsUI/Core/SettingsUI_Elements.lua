		...
		do -- Elements
			...
			do -- Background
				...
				local function UpdateTheme()
					...
					if addon.Theme.IsDarkTheme then
						BackgroundTexture = NS.Variables.SETTINGS_PATH .. "Background-Dark.png"
					else
						BackgroundTexture = NS.Variables.SETTINGS_PATH .. "Background-Light.png"
					end
			...
			do -- Content
				...
				do -- Divider
					...
					do -- Background
						...
						addon.API.Main:RegisterThemeUpdate(function()
							...
							if addon.Theme.IsDarkTheme then
								TEXTURE_Background = NS.Variables.SETTINGS_PATH .. "DividerVertical-Dark.png"
							else
								TEXTURE_Background = NS.Variables.SETTINGS_PATH .. "DividerVertical-Light.png"
							end
				...
				do -- Primary
					...
					do -- Header
						...
						do -- Background
							Frame.Content.Header.Background, Frame.Content.Header.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Frame.Content.Header, "FULLSCREEN_DIALOG", addon.API.Presets.TEXTURE_INSCRIBED, 50, 3.75, "$parent.Background")
						...
						do -- Content
							...
							do -- Divider
								Frame.Content.Header.Content.Divider, Frame.Content.Header.Content.DividerTexture = addon.API.FrameTemplates:CreateNineSlice(Frame.Content.Header.Content, "FULLSCREEN_DIALOG", addon.API.Presets.TEXTURE_INSCRIBED, 50, 1, "$parent.Divider")
							...
							do -- Title
								Frame.Content.Header.Content.Title = addon.API.FrameTemplates:CreateText(Frame.Content.Header, addon.Theme.RGB_RECOMMENDED, 17.5, "LEFT", "MIDDLE", GameFontNormal:GetFont(), "$parent.Title")
							...
							do -- Buttons
								...
								do -- Close
									Frame.Content.Header.Content.ButtonContainer.CloseButton = addon.API.FrameTemplates:CreateCustomButton(Frame.Content.Header.Content.ButtonContainer, NS.Variables:RATIO(5), Frame.Content.Header.Content.ButtonContainer:GetHeight(), "FULLSCREEN_DIALOG", {
										defaultTexture = addon.API.Presets.TEXTURE_INSCRIBED,
										highlightTexture = addon.API.Presets.TEXTURE_INSCRIBED,
										edgeSize = 50,
										scale = 1,
										theme = nil,
										playAnimation = false,
					...
					do -- Scroll frame
						...
						function Frame.Content.ScrollFrame.CreateTab(index)
							...
							do -- Top
								...
								do -- Icon
									...
									addon.API.Main:RegisterThemeUpdate(function()
										...
										if addon.Theme.IsDarkTheme then
											TEXTURE = addon.Variables.PATH_ART .. "Platform\\LB-Up-Light.png"
										else
											TEXTURE = addon.Variables.PATH_ART .. "Platform\\LB-Up.png"
										end
							...
							do -- Bottom
								...
								do -- Icon
									...
									addon.API.Main:RegisterThemeUpdate(function()
										...
										if addon.Theme.IsDarkTheme then
											TEXTURE = addon.Variables.PATH_ART .. "Platform\\RB-Down-Light.png"
										else
											TEXTURE = addon.Variables.PATH_ART .. "Platform\\RB-Down.png"
										end
			...
			do -- Tooltip
				...
				do -- Image
					...
					do -- Background
						Frame.Tooltip.Content.Image.Background, Frame.Tooltip.Content.Image.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Frame.Tooltip.Content.Image, "FULLSCREEN_DIALOG", NS.Variables.SETTINGS_PATH .. "TooltipImageBackground.png", 50, 1, "$parent.Background")
						...
						addon.API.Main:RegisterThemeUpdate(function()
							...
							if addon.Theme.IsDarkTheme then
								TEXTURE_Background = NS.Variables.SETTINGS_PATH .. "TooltipImageBackground-Dark.png"
							else
								TEXTURE_Background = NS.Variables.SETTINGS_PATH .. "TooltipImageBackground.png"
							end
				...
				do -- Text
					Frame.Tooltip.Content.Text = addon.API.FrameTemplates:CreateText(Frame.Tooltip.Content, addon.Theme.RGB_RECOMMENDED, 15, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.Text")
				...
				local function UpdateTheme()
					...
					if addon.Theme.IsDarkTheme then
						TEXTURE_Background = addon.API.Presets.TEXTURE_STYLIZED_SCROLL_DARK
					else
						TEXTURE_Background = addon.API.Presets.TEXTURE_STYLIZED_SCROLL_LIGHT
					end
