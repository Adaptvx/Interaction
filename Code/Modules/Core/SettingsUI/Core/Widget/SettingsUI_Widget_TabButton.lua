	...
	do -- Button
		...
		do -- Icon
			...
			addon.API.Main:RegisterThemeUpdate(function()
				...
				if addon.Theme.IsDarkTheme then
					TEXTURE_LEFT = addon.Variables.PATH_ART .. "Platform\\LB-Tab-Light.png"
					TEXTURE_RIGHT = addon.Variables.PATH_ART .. "Platform\\RB-Tab-Light.png"
				else
					TEXTURE_LEFT = addon.Variables.PATH_ART .. "Platform\\LB-Tab.png"
					TEXTURE_RIGHT = addon.Variables.PATH_ART .. "Platform\\RB-Tab.png"
				end
