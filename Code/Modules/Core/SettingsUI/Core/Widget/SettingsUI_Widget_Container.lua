    ...
    do -- Theme
        local function UpdateTheme()
            if addon.Theme.IsDarkTheme then
                ...
                Frame.TEXTURE_Background = addon.API.Presets.TEXTURE_INSCRIBED
    ...
    do -- Elements
        do -- Icon
            if subcategory and subcategory >= 1 then
                ...
                for subcategoryIndex = 1, subcategory do
                    Frame["Icon" .. subcategoryIndex], Frame["IconTexture" .. subcategoryIndex] = addon.API.FrameTemplates:CreateTexture(Frame, Frame:GetFrameStrata(), Frame.TEXTURE_Subcategory)
                    Frame["Icon" .. subcategoryIndex]:SetSize(height or 45, height or 52.5)
                    Frame["Icon" .. subcategoryIndex]:SetPoint("LEFT", Frame, 7.5 + (INDENTATION) * (subcategoryIndex - 1), 0)

                    addon.API.Main:RegisterThemeUpdate(function()
                                                           Frame["IconTexture" .. subcategoryIndex]:SetTexture(Frame.TEXTURE_Subcategory)
                                                       end, 5)
                end
        ...
        do -- Text
            ...
            Frame.Text = addon.API.FrameTemplates:CreateText(Frame.Container, addon.Theme.RGB_RECOMMENDED, 15, "LEFT", "MIDDLE", GameFontNormal:GetFont())
