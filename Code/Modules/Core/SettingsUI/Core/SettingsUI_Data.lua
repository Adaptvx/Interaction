	...
	do -- Content
		...
		local Elements_Appearance = {
			...
			args = {
				...
				Checkbox_Dialog_SplitParagraphs = {
					name = L["Checkbox - Dialog / Split Paragraphs"],
					tooltipImage = "",
					tooltipText = L["Checkbox - Dialog / Split Paragraphs - Tooltip"],
					tooltipTextDynamic = nil,
					tooltipImageType = "Small",
					type = "Checkbox",
					order = 13,
					...
					subcategory = 0,
					category = Appearance,
					get = function() return addon.Database.DB_GLOBAL.profile.INT_DIALOG_SPLIT_PARAGRAPHS end,
					set = function(_, val)
						if addon.Interaction.Variables.Active then return end
						addon.Database.DB_GLOBAL.profile.INT_DIALOG_SPLIT_PARAGRAPHS = val
						CallbackRegistry:Trigger("SETTINGS_DIALOG_SPLIT_PARAGRAPHS_CHANGED")
					end,
				},
				...
				Checkbox_Quest_BlizzardTooltip = {
					name = L["Checkbox - Blizzard Tooltip"],
					tooltipImage = "",
					tooltipText = L["Checkbox - Blizzard Tooltip - Tooltip"],
					tooltipTextDynamic = nil,
					tooltipImageType = "Small",
					type = "Checkbox",
					order = 20,
					...
					subcategory = 0,
					category = Appearance,
					get = function() return addon.Database.DB_GLOBAL.profile.INT_BLIZZARD_TOOLTIP end,
					set = function(_, val)
						addon.Database.DB_GLOBAL.profile.INT_BLIZZARD_TOOLTIP = val
						CallbackRegistry:Trigger("SETTING_BLIZZARD_TOOLTIP_CHANGED")
					end
				}
			}
		}
			...
			args = {
				...
				Group_TextToSpeech = {
					...
					args = {
						...
						Title_TextToSpeech_DuckAudio = {
							name = L["Title - Text To Speech - Duck Audio"],
							type = "Title",
							order = 24,
							hidden = function() return false end,
							subcategory = 1,
						...
						Checkbox_TextToSpeech_DuckAudio = {
							name = L["Checkbox - Text To Speech - Duck Audio"],
							tooltipImage = "",
							tooltipText = L["Checkbox - Text To Speech - Duck Audio - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Small",
							type = "Checkbox",
							order = 25,
							...
							subcategory = 1,
							category = Playback,
							get = function() return addon.Database.DB_GLOBAL.profile.INT_TTS_DUCK_AUDIO end,
							set = function(_, val)
								addon.Database.DB_GLOBAL.profile.INT_TTS_DUCK_AUDIO = val
							end,
						},
						Range_TextToSpeech_DuckAudioLevel = {
							name = L["Range - Text To Speech - Duck Audio / Level"],
							tooltipImage = "",
							tooltipText = L["Range - Text To Speech - Duck Audio / Level - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Small",
							type = "Range",
							min = 10,
							...
							step = 10,
							order = 26,
							hidden = function() return not addon.Database.DB_GLOBAL.profile.INT_TTS_DUCK_AUDIO end,
							locked = function() return false end,
							subcategory = 2,
							category = Playback,
							valueText = function(val)
							...
							get = function() return addon.Database.DB_GLOBAL.profile.INT_TTS_DUCK_AUDIO_LEVEL end,
							set = function(_, val) addon.Database.DB_GLOBAL.profile.INT_TTS_DUCK_AUDIO_LEVEL = val end
						},
					}
				},
				Title_More = {
										...
										Dropdown_Audiobook_Voice = {
											...
											set = function(_, val)
												if not InteractionReadableUIFrame:IsVisible() then
													...
													C_Timer.After(0, function()
														addon.TextToSpeech.Script:SpeakText(Voice, "Interaction example text.", Rate, Volume)
													end)
												end
											end,
											setCriteria = function()
		...
		local Elements_More = {
			...
			args = {
				...
				Group_SpecialCredits = {
					name = L["Title - Key Contributors"],
					type = "Group",
					order = 8,
					opacity = .5,
					hidden = function() return false end,
					...
					args = {
						...
						Title_Credits_MrFIXIT = {
							name = L["Title - Key Contributors / MrFIXIT"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Key Contributors / MrFIXIT - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 11,
				...
				Group_Credits = {
					...
					args = {
						...
						Title_Credits_ZamestoTV = {
							name = L["Title - Contributors / ZamestoTV"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Contributors / ZamestoTV - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 15,
						...
						Title_Credits_AKArenan = {
							name = L["Title - Contributors / AKArenan"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Contributors / AKArenan - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 16,
						...
						Title_Credits_cathtail = {
							name = L["Title - Contributors / cathtail"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Contributors / cathtail - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 17,
						...
						Title_Credits_El1as1989 = {
							name = L["Title - Contributors / El1as1989"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Contributors / El1as1989 - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 18,
						...
						Title_Credits_huchang47 = {
							name = L["Title - Contributors / huchang47"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Contributors / huchang47 - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 18,
						...
						Title_Credits_muiqo = {
							name = L["Title - Contributors / muiqo"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Contributors / muiqo - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 19,
						...
						Title_Credits_Crazyyoungs = {
							name = L["Title - Contributors / Crazyyoungs"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Contributors / Crazyyoungs - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 20,
						...
						Title_Credits_fang2hou = {
							name = L["Title - Contributors / fang2hou"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Contributors / fang2hou - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 21,
						...
						Title_Credits_joaoc_pires = {
							name = L["Title - Contributors / joaoc_pires"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Contributors / joaoc_pires - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 22,
						...
						Title_Credits_Walshi2 = {
							name = L["Title - Contributors / Walshi2"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Contributors / Walshi2 - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 23,
						...
						Title_Credits_lxwnk = {
							name = L["Title - Contributors / lx-wnk"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Contributors / lx-wnk - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 24,
