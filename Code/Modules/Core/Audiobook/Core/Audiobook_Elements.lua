...
function NS.Elements:Load()
	...
	do
		do -- Elements
			...
			do -- Elements
				...
				do -- Content
					...
					do -- Playback button
						...
						do -- Elements
							do -- Background
								Frame.Content.PlaybackButton.Background, Frame.Content.PlaybackButton.BackgroundTexture = addon.API.FrameTemplates:CreateTexture(Frame.Content.PlaybackButton, "FULLSCREEN", NS.Variables.AUDIOBOOKUI_PATH .. "ButtonPlayback.png", "$parent.Background")
							...
							do -- Image
								...
								Frame.Content.PlaybackButton.Image, Frame.Content.PlaybackButton.ImageTexture = addon.API.FrameTemplates:CreateTexture(Frame.Content.PlaybackButton, "FULLSCREEN", NS.Variables.AUDIOBOOKUI_PATH .. "Play.png", "$parent.Image")
						...
						do -- Animations
							do -- On enter
								...
								function Frame.Content.PlaybackButton:Animation_OnEnter(skipAnimation)
									Frame.Content.PlaybackButton.BackgroundTexture:SetTexture(NS.Variables.AUDIOBOOKUI_PATH .. "ButtonPlaybackHighlighted.png")
								end
							end
							...
							do -- On leave
								...
								function Frame.Content.PlaybackButton:Animation_OnLeave(skipAnimation)
									Frame.Content.PlaybackButton.BackgroundTexture:SetTexture(NS.Variables.AUDIOBOOKUI_PATH .. "ButtonPlayback.png")
								end
							end
					...
					do -- Text
						...
						do -- Index
							...
							do -- Background
								Frame.Content.Text.Index.Background, Frame.Content.Text.Index.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Frame.Content.Text.Index, "FULLSCREEN", addon.API.Presets.TEXTURE_INSCRIBED, 64, .5, "$parent.Background")
							...
							do -- Text
								Frame.Content.Text.Index.Text = addon.API.FrameTemplates:CreateText(Frame.Content.Text.Index, addon.Theme.RGB_WHITE, 15, "CENTER", "MIDDLE", GameFontNormal:GetFont(), "$parent.Text")
								Frame.Content.Text.Index.Text:SetAllPoints(Frame.Content.Text.Index, true)
							end
						end

						do -- Title
							Frame.Content.Text.Title = addon.API.FrameTemplates:CreateText(Frame.Content.Text, addon.Theme.RGB_WHITE, 15, "LEFT", "MIDDLE", GameFontNormal:GetFont(), "$parent.Title")
				...
				do -- Text preview
					...
					do -- Content
						...
						do -- Text
							Frame.TextPreviewFrame.Content.Text = addon.API.FrameTemplates:CreateText(Frame.TextPreviewFrame.Content, addon.Theme.RGB_CHAT_MSG_SAY, 12.5, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.Text")
			...
			do -- Click events
				function Frame.Animation_DragStart()
				...
				function Frame.Animation_DragStop()
				...
				function Frame.Animation_CloseStart()
				...
				function Frame.Animation_CloseStop()
