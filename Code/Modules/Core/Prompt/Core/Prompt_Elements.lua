...
function NS.Elements:Load()
	do
		do -- Elements
			...
			do -- Backdrop
				Frame.Backdrop, Frame.BackdropTexture = addon.API.FrameTemplates:CreateTexture(Frame, NS.Variables.FRAME_STRATA, addon.Variables.PATH_ART .. "Settings\\Background-Dark.png", "$parent.Backdrop")
