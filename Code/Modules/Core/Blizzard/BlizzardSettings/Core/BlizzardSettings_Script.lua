	...
	do
		hooksecurefunc(Frame, "Show", function()
			...
			if addon.Input.Variables.IsController then
				Shortcut = addon.API.Util:InlineIcon(NS.Variables.PATH .. "Shortcut-GamePad.png", 25, 25, 0, 0) .. L["BlizzardSettings - Shortcut - Controller"]
			else
				Shortcut = addon.API.Util:InlineIcon(NS.Variables.PATH .. "Shortcut-KBM.png", 40, 130, 0, 0)
			end
