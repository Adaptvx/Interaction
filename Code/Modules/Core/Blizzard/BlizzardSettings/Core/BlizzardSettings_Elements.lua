		...
		do -- Elements
			...
			do -- Content
				...
				do -- Title
					...
					do -- Background
						Frame.Content.Title.Background, Frame.Content.Title.BackgroundTexture = addon.API.FrameTemplates:CreateTexture(Frame.Content.Title, "HIGH", NS.Variables.PATH .. "ContentBackground.png")
