...
L["Audiobook - Action Tooltip"] = addon.API.Util:InlineIcon(addon.Variables.PATH_ART .. "Icons\\Mouse-LeftButton.png", 16, 16, 0, 0) .. " 拖曳。\n" .. addon.API.Util:InlineIcon(addon.Variables.PATH_ART .. "Icons\\Mouse-RightButton.png", 16, 16, 0, 0) .. " 關閉。"
