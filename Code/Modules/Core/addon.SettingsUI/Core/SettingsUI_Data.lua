				...
				Group_SpecialCredits = {
					...
					args = {
						...
						Title_Credits_MrFIXIT = {
							name = L["Title - Special Credits / MrFIXIT"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Special Credits / MrFIXIT - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 11,
				...
				Group_Credits = {
					...
					args = {
						...
						Title_Credits_fang2hou = {
							name = L["Title - Credits / fang2hou"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Credits / fang2hou - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 21,
						...
						Title_Credits_Walshi2 = {
							name = L["Title - Credits / Walshi2"],
							tooltipImage = NS.Variables.TOOLTIP_PATH .. "Acknowledgement.png",
							tooltipText = L["Title - Credits / Walshi2 - Tooltip"],
							tooltipTextDynamic = nil,
							tooltipImageType = "Large",
							type = "Title",
							order = 23,
