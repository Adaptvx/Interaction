	...
	do
		do -- Elements
			...
			do -- Notification
				...
				do -- Background
					Notification.Background, Notification.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Notification, NS.Variables.FRAME_STRATA, addon.Variables.PATH_ART .. "Gradient\\ShadowNineslice.png", 128, .5, "$parent.Background")
				...
				do -- Layout group
					...
					do -- Elements
						...
						do -- Text
							LayoutGroup.Text = addon.API.FrameTemplates:CreateText(LayoutGroup, addon.Theme.RGB_WHITE, 15, "LEFT", "MIDDLE", GameFontNormal:GetFont(), "$parent.Text")
