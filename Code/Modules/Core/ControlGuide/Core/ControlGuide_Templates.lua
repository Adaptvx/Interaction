...
function NS.Templates:Load()
	do -- Element
		TemplateRegistry:Add("ControlGuide.Element", function(parent, frameStrata, frameLevel, name)
			...
			do -- Elements
				...
				do -- Content
					do -- Text
						Content.Text = addon.API.FrameTemplates:CreateText(Content, addon.Theme.RGB_WHITE, 12.5, "LEFT", "MIDDLE", GameFontNormal:GetFont(), "$parent.Text")
