...
local function Load()
	...
	do
		-- WARNINGS
		L["Warning - Leave NPC Interaction"] = "離開 NPC 互動來調整設定"
		L["Warning - Leave ReadableUI"] = "離開 Readable UI 來調整設定"

		-- PROMPTS
		L["Prompt - Reload"] = "需要重新載入介面以應用設定"
		L["Prompt - Reload Button 1"] = "重新載入"
		L["Prompt - Reload Button 2"] = "關閉"
		L["Prompt - Reset Settings"] = "您確定要重置設定嗎？"
		L["Prompt - Reset Settings Button 1"] = "重置設定"
		L["Prompt - Reset Settings Button 2"] = "取消"

		-- TABS
		L["Tab - Appearance"] = "介面外觀"
		L["Tab - Effects"] = "特效"
		L["Tab - Playback"] = "回放"
		L["Tab - Controls"] = "輸入控制"
		...
		L["Title - Text"] = "Text"
		L["Range - Content Size"] = "Text Size"
		L["Range - Content Size - Tooltip"] = "Adjust text size."
		...
		L["Checkbox - PC / Keyboard / Use Interact Key - Tooltip"] = "Use the interact key for Skip/Accept instead of Space. Multi-key combinations not supported.\n\nDefault: Off."
