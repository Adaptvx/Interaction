...
local function Load()
	...
	do
		...
		L["Title - Special Credits"] = "特别感谢"
		L["Title - Special Credits / MrFIXIT"] = "MrFIXIT | 编码者 - 修复Bug和增强功能"
		L["Title - Special Credits / MrFIXIT - Tooltip"] = "特别感谢 MrFIXIT 为超炫交互修复了许多严重的错误和增强功能！"
		...
		L["Title - Credits / Walshi2"] = "Walshi2 | 编码者 - 修复Bug"
		L["Title - Credits / Walshi2 - Tooltip"] = "特别感谢 Walshi2 修复的Bug！"
	end
