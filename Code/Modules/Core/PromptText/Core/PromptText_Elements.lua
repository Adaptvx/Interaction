	...
	do
		do -- Elements
			...
			do -- Background
				...
				addon.API.Main:RegisterThemeUpdate(function()
					...
					if addon.Theme.IsDarkTheme then
						TEXTURE_Background = addon.API.Presets.TEXTURE_INSCRIBED_FILLED_HIGHLIGHT
					else
						TEXTURE_Background = addon.API.Presets.TEXTURE_INSCRIBED_FILLED_HIGHLIGHT
					end
			...
			do -- Content
				...
				do -- Title
					do -- Text
						Frame.TitleArea.Title = addon.API.FrameTemplates:CreateText(Frame.TitleArea, addon.Theme.RGB_WHITE, 15, "LEFT", "MIDDLE", GameFontNormal:GetFont(), "$parent.Title")
					...
					do -- Buttons
						do -- Close
							Frame.TitleArea.CloseButton = addon.API.FrameTemplates:CreateCustomButton(Frame.TitleArea, 25, 25, "FULLSCREEN_DIALOG", {
								defaultTexture = NS.Variables.TEXTURE_BUTTON_HEAVY,
								highlightTexture = NS.Variables.TEXTURE_BUTTON_HIGHLIGHT,
								edgeSize = 25,
								scale = 1,
								theme = 2,
								playAnimation = false,
				...
				do -- Input box
					...
					Frame.InputArea.InputBox:SetFont(GameFontNormal:GetFont(), 12.5, "")
					...
					do -- Hint
						Frame.InputArea.InputBox.Hint = addon.API.FrameTemplates:CreateText(Frame.InputArea.InputBox, addon.Theme.RGB_WHITE, 12.5, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.Hint")
