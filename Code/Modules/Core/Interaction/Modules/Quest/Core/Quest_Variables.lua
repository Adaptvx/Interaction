...
addon.API.Main:RegisterThemeUpdate(function()
                                       if addon.Theme.IsDarkTheme then
                                           NS.Variables.THEME.INSCRIBED_BACKGROUND = addon.API.Presets.TEXTURE_INSCRIBED
                                           NS.Variables.THEME.INSCRIBED_BACKGROUND_HIGHLIGHT = addon.API.Presets.TEXTURE_INSCRIBED
                                           NS.Variables.THEME.INSCRIBED_HEADER = addon.Variables.PATH_ART .. "Quest\\Header.png"
                                       else
                                           NS.Variables.THEME.INSCRIBED_BACKGROUND = addon.API.Presets.TEXTURE_INSCRIBED
                                           NS.Variables.THEME.INSCRIBED_BACKGROUND_HIGHLIGHT = addon.API.Presets.TEXTURE_INSCRIBED
                                           NS.Variables.THEME.INSCRIBED_HEADER = addon.Variables.PATH_ART .. "Quest\\Header.png"
