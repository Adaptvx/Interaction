			...
			do -- Context icon
				...
				do -- Background
					...
					addon.API.Main:RegisterThemeUpdate(function()
						...
						if addon.Theme.IsDarkTheme then
							TEXTURE_Background = NS.Variables.QUEST_PATH .. "ContextBackground-Dark.png"
						else
							TEXTURE_Background = NS.Variables.QUEST_PATH .. "ContextBackground-Light.png"
						end
				...
				do -- Text
					ContextIcon.Text = addon.API.FrameTemplates:CreateText(ContextIcon, addon.Theme.RGB_WHITE, 35, "CENTER", "MIDDLE", GameFontNormal:GetFont(), "$parent.Text")
							...
							do -- Layout group
								...
								do -- Elements
									do -- Title frame
										...
										do -- Text
											TitleFrame.Text = addon.API.FrameTemplates:CreateText(TitleFrame, addon.Theme.RGB_WHITE, TITLE_TEXT_SIZE, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.Text")
									...
									do -- Storyline frame
										...
										do -- Storyline
											StorylineFrame.Storyline = TemplateRegistry:Create("Quest.Storyline", StorylineFrame, NS.Variables.FRAME_STRATA, NS.Variables.FRAME_LEVEL + 11, "$parent.Storyline")
								...
								do -- Layout group
									...
									do -- Elements
										local function CreateHeader(parent)
											local Header = TemplateRegistry:Create("Quest.Content.Header", parent, ScrollChildFrame_LayoutGroup, NS.Variables.FRAME_STRATA, NS.Variables.FRAME_LEVEL + 4, "$parent.Header")

											return Header
										end

										local function CreateHeaderReward(parent)
											local Header = TemplateRegistry:Create("Quest.Content.Header.Reward", parent, ScrollChildFrame_LayoutGroup, NS.Variables.FRAME_STRATA, NS.Variables.FRAME_LEVEL + 4, "$parent.HeaderReward")
											return Header
										end

										local function CreateReward(parent, selectable)
											local Reward = TemplateRegistry:Create("Quest.Content.Reward", parent, selectable, NS.Variables.FRAME_STRATA, NS.Variables.FRAME_LEVEL + 4, "$parent.Reward")
											return Reward
										end

										local function CreateText(parent)
											local Text = addon.API.FrameTemplates:CreateText(parent, addon.Theme.RGB_WHITE, CONTENT_TEXT_SIZE, "LEFT", "TOP", GameFontNormal:GetFont())
											Text:SetAlpha(.75)
						...
						do -- Content
							...
							do -- Buttons
								local function CreateButton(name, color, highlightColor, color_darkTheme, highlightColor_darkTheme)
									local Button = TemplateRegistry:Create("Quest.ButtonContainer.Button", Footer_Content, color, highlightColor, color_darkTheme, highlightColor_darkTheme, NS.Variables.FRAME_STRATA, NS.Variables.FRAME_LEVEL + 9, name)
									return Button
								end
