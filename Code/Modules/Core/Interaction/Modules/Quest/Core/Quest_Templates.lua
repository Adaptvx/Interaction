        ...
        do -- Button
            TemplateRegistry:Add("Quest.ButtonContainer.Button", function(parent, color, highlightColor, color_darkTheme, highlightColor_darkTheme, frameStrata, frameLevel, name)
                ...
                addon.API.FrameTemplates.Styles:Button(Frame, {
                    defaultTexture       = addon.API.Presets.TEXTURE_INSCRIBED_FILLED_HIGHLIGHT,
                    highlightTexture     = addon.API.Presets.TEXTURE_INSCRIBED_FILLED_HIGHLIGHT,
                    edgeSize             = 25,
                    scale                = .5,
                    playAnimation        = false,
                    customColor          = color,
                ...
                do -- Functions
                    do -- Set
                        ...
                        function Frame:RefreshLayout()
                            local ImageFrame = Frame.Content.Content.LayoutGroup.ImageFrame
                            local Text = Frame.Content.Content.LayoutGroup.TextFrame.Text
                            local imageWidth = ImageFrame:IsShown() and ImageFrame:GetWidth() + (PADDING / 2) or 0
                            local textWidth = Text:GetStringWidth() or 0

                            Frame:SetSize(PADDING + imageWidth + textWidth + PADDING, 27.5)
            ...
            TemplateRegistry:Add("Quest.Content.Reward", function(parent, selectable, frameStrata, frameLevel, name)
                ...
                do -- Elements
                    ...
                    do -- Image
                        ...
                        do -- Background
                            Frame.Image.Background, Frame.Image.BackgroundTexture = addon.API.FrameTemplates:CreateTexture(Frame.Image, frameStrata, addon.API.Presets.BOX, "$parent.Background")
                        ...
                        do -- Text
                            ...
                            do -- Background
                                Frame.Image.Text.Background, Frame.Image.Text.BackgroundTexture = addon.API.FrameTemplates:CreateTexture(Frame.Image.Text, "HIGH", addon.API.Presets.BOX, "$parent.Background")
                    ...
                    do -- Highlight
                        ...
                        do -- Background
                            Frame.Highlight.Background, Frame.Highlight.BackgroundTexture = addon.API.FrameTemplates:CreateTexture(Frame.Highlight, "HIGH", NS.Variables.QUEST_PATH .. "RewardHighlight.png", "$parent.Texture")
