				...
				do -- Layout group
					...
					do -- Elements
							...
							do -- Background
								...
								do -- Theme
									addon.API.Main:RegisterThemeUpdate(function()
										...
										if addon.Theme.IsDarkTheme then
											BackgroundTexture = NS.Variables.PATH .. "ModelBorder-Dark.png"
										else
											BackgroundTexture = NS.Variables.PATH .. "ModelBorder.png"
										end
						...
						do -- Title frame
							...
							do -- Text
								TitleFrame.Text = addon.API.FrameTemplates:CreateText(TitleFrame, addon.Theme.RGB_WHITE, 15, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.Text")
						...
						do -- Description frame
							...
							do -- Text
								DescriptionFrame.Text = addon.API.FrameTemplates:CreateText(DescriptionFrame, addon.Theme.RGB_WHITE, 12, "LEFT", "TOP", GameFontNormal:GetFont(), "$parent.Text")
