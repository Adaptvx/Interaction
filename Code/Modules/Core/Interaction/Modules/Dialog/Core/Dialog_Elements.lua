...
function NS.Elements:Load()
	...
	do
		do -- Elements
			...
			do -- Background
							...
							addon.API.Main:RegisterThemeUpdate(function()
								...
								if addon.LoadedAddons.ElvUI then
									...
									if addon.Theme.IsDarkTheme_Dialog then
										TooltipTexture = addon.API.Presets.TEXTURE_TOOLTIP_DARK
									else
										TooltipTexture = addon.API.Presets.TEXTURE_TOOLTIP_LIGHT
									end
						...
						do -- Theme
							addon.API.Main:RegisterThemeUpdate(function()
								...
								if addon.LoadedAddons.ElvUI then
									...
									if addon.Theme.IsDarkTheme_Dialog then
										TEXTURE_Background = addon.Variables.PATH_ART .. "Dialog\\TooltipTail-Dark.png"
									else
										TEXTURE_Background = addon.Variables.PATH_ART .. "Dialog\\TooltipTail-Light.png"
									end
								end
						...
						do -- Theme
							addon.API.Main:RegisterThemeUpdate(function()
								...
								if addon.Theme.IsDarkTheme_Dialog or addon.Theme.IsRusticTheme_Dialog then
									ScrollTexture = addon.API.Presets.TEXTURE_STYLIZED_SCROLL_DARK
								else
									ScrollTexture = addon.API.Presets.TEXTURE_STYLIZED_SCROLL_LIGHT
								end
				...
				do -- Style (RUSTIC)
					...
					do -- Background
						Style_Rustic.Background, Style_Rustic.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Style_Rustic, NS.Variables.FRAME_STRATA, addon.Variables.PATH_ART .. "Gradient\\ShadowNineslice.png", 128, .5, "$parent.Background")
				...
				do -- Style (EMOTE)
					...
					do -- Background
						Style_Emote.Background, Style_Emote.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Style_Emote, NS.Variables.FRAME_STRATA, addon.Variables.PATH_ART .. "Gradient\\ShadowNineslice.png", 128, .5, "$parent.Background")
				...
				do -- Layout group
					...
					do -- Elements
						...
						do -- Prefix frame
							...
							do -- Text
								PrefixFrame.Text = addon.API.FrameTemplates:CreateText(PrefixFrame, addon.Theme.RGB_WHITE, 12.5, "CENTER", "MIDDLE", GameFontNormal:GetFont(), "$parent.Text")
						...
						do -- Title frame
							...
							do -- Text
								TitleFrame.Text = addon.API.FrameTemplates:CreateText(TitleFrame, addon.Theme.RGB_WHITE, 15, "CENTER", "MIDDLE", GameFontNormal:GetFont(), "$parent.Text")
						...
						do -- Secret title frame
							LayoutGroup.SecretTitleFrame = CreateFrame("Frame", "$parent.SecretTitleFrame", LayoutGroup)
							LayoutGroup.SecretTitleFrame:SetHeight(25)
							LayoutGroup.SecretTitleFrame:SetFrameStrata(NS.Variables.FRAME_STRATA)
							LayoutGroup.SecretTitleFrame:SetFrameLevel(NS.Variables.FRAME_LEVEL + 2)
							LayoutGroup.SecretTitleFrame:Hide()
							addon.API.FrameUtil:SetDynamicSize(LayoutGroup.SecretTitleFrame, LayoutGroup, 0, nil)
							LayoutGroup:AddElement(LayoutGroup.SecretTitleFrame)

							local SecretTitleFrame = LayoutGroup.SecretTitleFrame

							do -- Text
								SecretTitleFrame.Text = SecretTitleFrame:CreateFontString("$parent.Text", "OVERLAY")
								SecretTitleFrame.Text:SetPoint("TOP", SecretTitleFrame, 8, 0)
								SecretTitleFrame.Text:SetHeight(25)
								SecretTitleFrame.Text:SetFont(GameFontNormal:GetFont(), 15, "")
								SecretTitleFrame.Text:SetJustifyH("CENTER")
								SecretTitleFrame.Text:SetJustifyV("MIDDLE")
								SecretTitleFrame.Text:SetTextColor(addon.Theme.RGB_WHITE.r, addon.Theme.RGB_WHITE.g, addon.Theme.RGB_WHITE.b)

								SecretTitleFrame.Icon = SecretTitleFrame:CreateFontString("$parent.Icon", "OVERLAY")
								SecretTitleFrame.Icon:SetPoint("RIGHT", SecretTitleFrame.Text, "LEFT", -4, 0)
								SecretTitleFrame.Icon:SetFont(GameFontNormal:GetFont(), 15, "")
								SecretTitleFrame.Icon:SetJustifyH("RIGHT")
								SecretTitleFrame.Icon:SetJustifyV("MIDDLE")
								SecretTitleFrame.Icon:SetTextColor(addon.Theme.RGB_WHITE.r, addon.Theme.RGB_WHITE.g, addon.Theme.RGB_WHITE.b)
							end
						end
						...
						do -- Progress
							...
							do -- Elements
								do -- Background
									Progress.Background, Progress.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Progress, NS.Variables.FRAME_STRATA, addon.API.Presets.BOX, 25, 1, "$parent.Progress")
								...
								do -- Bar
									...
									Progress.Bar:SetStatusBarTexture(addon.API.Presets.BOX)
			...
			do -- Content
				...
				do -- Text
					...
					Content.Text = addon.API.FrameTemplates:CreateText(Frame.Content, addon.Theme.RGB_WHITE, TEXT_SIZE, "LEFT", "TOP", GameFontNormal:GetFont())
		...
		do -- References
			...
			Frame.REF_TITLE_SECRETTITLEFRAME = Frame.REF_TITLE.LayoutGroup.SecretTitleFrame
			Frame.REF_TITLE_SECRETTITLEFRAME_ICON = Frame.REF_TITLE_SECRETTITLEFRAME.Icon
			Frame.REF_TITLE_SECRETTITLEFRAME_TEXT = Frame.REF_TITLE_SECRETTITLEFRAME.Text
