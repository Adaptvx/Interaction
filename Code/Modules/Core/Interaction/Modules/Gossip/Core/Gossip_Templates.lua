...
function NS.Templates:Load()
	do -- Content
		do -- Option button
			...
			TemplateRegistry:Add("Gossip.OptionButton", function(parent, frameStrata, frameLevel, name)
					...
					do -- Content
						...
						do -- Content
							...
							do -- Keybind
								...
								do -- Background
									Keybind.Background, Keybind.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Subcontent.Keybind, frameStrata, NS.Variables.PATH .. "KeyBackground-Light.png", 50, 1, "$parent.Background")
									...
									do -- Theme
										addon.API.Main:RegisterThemeUpdate(function()
											...
											if addon.Theme.IsDarkTheme_Dialog or addon.Theme.IsRusticTheme_Dialog then
												TEXTURE_Background = NS.Variables.PATH .. "KeyBackground-Dark.png"
											else
												TEXTURE_Background = NS.Variables.PATH .. "KeyBackground-Light.png"
											end
								...
								do -- Label
									Keybind.Text = addon.API.FrameTemplates:CreateText(Keybind, addon.Theme.RGB_WHITE, 15, "CENTER", "MIDDLE", GameFontNormal:GetFont(), "$parent.Text")
							...
							do -- Layout group
								...
								do -- Text frame
									...
									do -- Text
										TextFrame.Text = addon.API.FrameTemplates:CreateText(TextFrame, addon.Theme.RGB_WHITE, 14, "LEFT", "MIDDLE", GameFontNormal:GetFont(), "$parent.Text")
				...
				do -- Animations
					do -- On enter
						...
						function Frame:Animation_OnEnter(skipAnimation)
							...
							if addon.Theme.IsDarkTheme_Dialog or addon.Theme.IsRusticTheme_Dialog then
								TEXTURE_BACKGROUND = NS.Variables.PATH .. "BackgroundHighlighted-Dark.png"
								TEXTURE_KEYBIND = NS.Variables.PATH .. "KeyBackgroundHighlighted.png"
							else
								TEXTURE_BACKGROUND = NS.Variables.PATH .. "BackgroundHighlighted-Light.png"
								TEXTURE_KEYBIND = NS.Variables.PATH .. "KeyBackgroundHighlighted.png"
							end
					...
					do -- On leave
						...
						function Frame:Animation_OnLeave(skipAnimation)
							...
							if addon.Theme.IsDarkTheme_Dialog or addon.Theme.IsRusticTheme_Dialog then
								TEXTURE_BACKGROUND = NS.Variables.PATH .. "Background-Dark.png"
								TEXTURE_KEYBIND = NS.Variables.PATH .. "KeyBackground-Dark.png"
							else
								TEXTURE_BACKGROUND = NS.Variables.PATH .. "Background-Light.png"
								TEXTURE_KEYBIND = NS.Variables.PATH .. "KeyBackground-Light.png"
							end
	...
	do -- Footer
		do -- Button
			do -- Goodbye
				TemplateRegistry:Add("Gossip.Footer.Button.Goodbye", function(parent, frameStrata, frameLevel, name)
					...
					do -- Elements
						do -- Background
							Frame.Background, Frame.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Frame, frameStrata, addon.Variables.PATH_ART .. "Gradient\\ShadowNineslice.png", 128, .5, "$parent.Background")
