		...
		do -- Option button
			...
			do -- Logic
				...
				function Callback.OptionButtons:Click(button)
					local PATH_GOSSIP = addon.Variables.PATH_ART .. "ContextIcons\\Gossip.png"
		...
		do -- Frame
			do -- Show
				...
				function Frame:ShowWithAnimation(bypass)
					...
					NS.Variables.CurrentSession.id = addon.Interaction.Variables.CurrentSession.id
			...
			do -- Hide
				...
				function Frame:HideWithAnimation(bypass)
					...
					NS.Variables.CurrentSession.id = nil
