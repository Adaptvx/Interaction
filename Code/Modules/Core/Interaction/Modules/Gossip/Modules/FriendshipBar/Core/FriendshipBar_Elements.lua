...
function NS.Elements:Load()
	do -- Elements
		...
		do -- Image
			...
			do -- Background
                Image.Background, Image.BackgroundTexture = addon.API.FrameTemplates:CreateTexture(Image, "FULLSCREEN", NS.Variables.PATH .. "ImageBackground.png", "$parent.Background")
			...
			do -- Image
				...
				do -- Mask texture
					...
					Image.ImageTexture.Mask:SetTexture(NS.Variables.PATH .. "ImageMask.png")
