		...
		do -- Gradient
			local function Settings_UIDirection()
				if addon.Database.DB_GLOBAL.profile.INT_UIDIRECTION == 1 then
					Frame.REF_GRADIENT.BackgroundTexture:SetTexture(addon.Variables.PATH_ART .. "Gradient\\GradientFullscreenLeft.png")
				elseif addon.Database.DB_GLOBAL.profile.INT_UIDIRECTION == 2 then
					Frame.REF_GRADIENT.BackgroundTexture:SetTexture(addon.Variables.PATH_ART .. "Gradient\\GradientFullscreenRight.png")
				end
			end
