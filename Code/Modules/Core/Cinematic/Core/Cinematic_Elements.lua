	...
	do
		do -- Elements
			...
			do -- Vignette
				...
				do -- Texture
					InteractionFrame.CinematicMode.Vignette.Texture, _ = addon.API.FrameTemplates:CreateNineSlice(InteractionFrame.CinematicMode.Vignette, "BACKGROUND", addon.API.Presets.TEXTURE_VIGNETTE_DARK, 256, 1)
