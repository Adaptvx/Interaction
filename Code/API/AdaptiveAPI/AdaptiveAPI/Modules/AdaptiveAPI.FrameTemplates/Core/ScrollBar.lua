...
do
	...
	function NS:CreateScrollbar(parent, frameStrata, data, name)
		local scrollFrame, scrollChildFrame, sizeX, sizeY, theme,
		customDefaultTexture, customHighlightTexture, customThumbTexture, customThumbHighlightTexture,
		customColor, customHighlightColor, customThumbColor, customThumbHighlightColor,
		isHorizontal =
			data.scrollFrame, data.scrollChildFrame, data.sizeX, data.sizeY, data.theme,
			data.customDefaultTexture, data.customHighlightTexture, data.customThumbTexture, data.customThumbHighlightTexture,
			data.customColor, data.customHighlightColor, data.customThumbColor, data.customThumbHighlightColor, data.isHorizontal
	...
	function NS:UpdateScrollbarTheme(scrollbar, data)
		local customDefaultTexture, customHighlightTexture, customThumbTexture, customThumbHighlightTexture,
		customColor, customHighlightColor, customThumbColor, customThumbHighlightColor = data.customDefaultTexture, data.customHighlightTexture, data.customThumbTexture, data.customThumbHighlightTexture,
			data.customColor, data.customHighlightColor, data.customThumbColor, data.customThumbHighlightColor

		--------------------------------

		if customDefaultTexture then scrollbar._DefaultTexture = customDefaultTexture end
		if customHighlightTexture then scrollbar._HighlightTexture = customHighlightTexture end
		if customThumbTexture then scrollbar._ThumbTexture = customThumbTexture end
		if customThumbHighlightTexture then scrollbar._ThumbHighlightTexture = customThumbHighlightTexture end
		if customColor then scrollbar._Color = customColor end
		if customHighlightColor then scrollbar._HighlightColor = customHighlightColor end
		if customThumbColor then scrollbar._ThumbColor = customThumbColor end
		if customThumbHighlightColor then scrollbar._ThumbHighlightColor = customThumbHighlightColor end
	end
end
