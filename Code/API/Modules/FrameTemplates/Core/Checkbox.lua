	...
	function NS:CreateCheckbox(parent, frameStrata, frameLevel, data, name)
		...
		do -- Theme
			local function UpdateTheme()
				if (theme and theme == 2) or (theme == nil and addon.API.Main:GetDarkTheme()) then
					Frame._DefaultTexture = Frame._CustomDefaultTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\CheckBackground.png"
					Frame._HighlightTexture = Frame._CustomHighlightTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\CheckBackgroundHighlighted.png"
				...
				elseif (theme and theme == 1) or (theme == nil and not addon.API.Main:GetDarkTheme()) then
					Frame._DefaultTexture = Frame._CustomDefaultTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\CheckBackground.png"
					Frame._HighlightTexture = Frame._CustomHighlightTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\CheckBackgroundHighlighted.png"
					Frame._CheckTexture = Frame._CustomCheckTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\Check-Dark.png"
