	...
	function NS:CreateDropdown(mainParent, parent, frameStrata, data, name)
		...
		do -- Theme
			local function UpdateTheme()
				if (theme and theme == 2) or (theme == nil and addon.API.Main:GetDarkTheme()) then -- Dark mode
					Frame._DefaultTexture = Frame._CustomDefaultTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\DropdownBackground.png"
					Frame._HighlightTexture = Frame._CustomHighlightTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\DropdownBackgroundHighlighted.png"
					Frame._ArrowTexture = Frame._CustomArrowTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ArrowDown-Light.png"
					Frame._ArrowHighlightTexture = Frame._CustomArrowHighlightTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ArrowDown-Light.png"
					Frame._ArrowEnableTexture = Frame._CustomArrowEnableTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ArrowUp-Light.png"
					...
					Frame._ListTexture = Frame._CustomListTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\DropdownListBackground-Dark.png"
					Frame._ListButtonTexture = Frame._CustomListButtonTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\DropdownListButtonBackground.png"
					Frame._ListButtonCheckTexture = Frame._CustomListButtonCheckTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\DropdownListButtonCheck.png"
					Frame._ListIndexBackgroundTexture = Frame._CustomListIndexBackgroundTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\DropdownListIndexBackground-Dark.png"
					Frame._ListIndexNextButtonTexture = Frame._CustomListIndexNextButtonTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ArrowRight-Light.png"
					Frame._ListIndexPreviousButtonTexture = Frame._CustomListIndexPreviousButtonTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ArrowLeft-Light.png"
				...
				elseif (theme and theme == 1) or (theme == nil and not addon.API.Main:GetDarkTheme()) then -- Light mode
					Frame._DefaultTexture = Frame._CustomDefaultTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\DropdownBackground.png"
					Frame._HighlightTexture = Frame._CustomHighlightTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\DropdownBackgroundHighlighted.png"
					Frame._ArrowTexture = Frame._CustomArrowTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ArrowDown-Dark.png"
					Frame._ArrowHighlightTexture = Frame._CustomArrowHighlightTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ArrowDown-Light.png"
					Frame._ArrowEnableTexture = Frame._CustomArrowEnableTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ArrowUp-Light.png"
					...
					Frame._ListTexture = Frame._CustomListTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\DropdownListBackground-Light.png"
					Frame._ListButtonTexture = Frame._CustomListButtonTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\DropdownListButtonBackground.png"
					Frame._ListButtonCheckTexture = Frame._CustomListButtonCheckTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\DropdownListButtonCheck.png"
					Frame._ListIndexBackgroundTexture = Frame._CustomListIndexBackgroundTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\DropdownListIndexBackground-Light.png"
					Frame._ListIndexNextButtonTexture = Frame._CustomListIndexNextButtonTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ArrowRight-Light.png"
					Frame._ListIndexPreviousButtonTexture = Frame._CustomListIndexPreviousButtonTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ArrowLeft-Light.png"
					Frame._ListColor = Frame._CustomListColor or { r = 1, g = 1, b = 1, a = 1 }
					Frame._ListElementColor = Frame._CustomListElementColor or { r = .1, g = .1, b = .1, a = .125 }
		...
		do -- Elements
			do -- Dropdown
				...
				do -- Text
					Frame.Text = addon.API.FrameTemplates:CreateText(Frame, Frame._DefaultTextColor, Frame._TextSize, "LEFT", "MIDDLE", GameFontNormal:GetFont(), "$parent.Label", false)
				...
				do -- Elements
					...
					do -- Content
						...
						do -- Elements
							local function CreateElement(parent, index)
								...
								do -- Elements
									...
									do -- Text
										Element.Text = addon.API.FrameTemplates:CreateText(Element, Frame._ListElementTextColor, Frame._TextSize, "LEFT", "MIDDLE", GameFontNormal:GetFont(), "$parent.Text", false)
										Element.Text:SetPoint("LEFT", Element, PADDING, 0)
						...
						do -- Index
							...
							do -- Label
								Frame.List.Content.Index.Label = addon.API.FrameTemplates:CreateText(Frame.List.Content.Index, Frame._ListPrimaryColor, Frame._TextSizeTitle, "CENTER", "MIDDLE", GameFontNormal:GetFont(), "$parent.Label")
