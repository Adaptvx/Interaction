		...
		do -- Theme
			local function UpdateTheme()
				if (theme and theme == 2) or (not theme and addon.API.Util.IsDarkTheme) then
					Frame._DefaultTexture = Frame._CustomDefaultTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ScrollBarBackground.png"
					Frame._HighlightTexture = Frame._CustomHighlightTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ScrollBarBackgroundHighlighted.png"
					Frame._ThumbTexture = Frame._CustomThumbTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ScrollBarThumb.png"
					Frame._ThumbHighlightTexture = Frame._CustomThumbHighlightTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\ScrollBarThumbHighlighted.png"
