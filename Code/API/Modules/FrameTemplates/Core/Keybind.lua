		...
		do -- Theme
			local function UpdateTheme()
				if (theme and theme == 2) or (theme == nil and addon.API.Main:GetDarkTheme()) then -- Dark mode
					Frame._DefaultTexture = Frame._CustomDefaultTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\KeybindBackgroundOutline-Light.png"
					Frame._HighlightTexture = Frame._CustomHighlightTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\KeybindBackgroundHighlighted-Light.png"
					Frame._ActiveTexture = Frame._CustomActiveTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\KeybindBackgroundActive-Light.png"
				...
				elseif (theme and theme == 1) or (theme == nil and not addon.API.Main:GetDarkTheme()) then -- Light mode
					Frame._DefaultTexture = Frame._CustomDefaultTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\KeybindBackground-Light.png"
					Frame._HighlightTexture = Frame._CustomHighlightTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\KeybindBackgroundHighlighted-Light.png"
					Frame._ActiveTexture = Frame._CustomActiveTexture or addon.Variables.PATH_ART .. "Elements\\Elements\\KeybindBackgroundActive-Light.png"
					Frame._DefaultColor = Frame._CustomDefaultColor or { r = .1, g = .1, b = .1, a = 1 }
					Frame._TextColor = Frame._CustomTextColor or { r = .1, g = .1, b = .1, a = 1 }
