...
do
	...
	function NS:CreateScrollBox(parent, data, name)
		local TemplateTemplate, elementCallback, stepSize, smoothScrollingRatio = data.TemplateTemplate, data.elementCallback, data.stepSize, data.smoothScrollingRatio
		...
		do -- Logic
			...
			Frame.ScrollView:SetElementInitializer(TemplateTemplate, elementCallback)
		end
		...
		do -- Events
			...
			do -- Functions
				...
				function Frame:SetElementInfo(TemplateTemplate, elementCallback)
					Frame.ScrollView:SetElementInitializer(TemplateTemplate, elementCallback)
				end
			end
