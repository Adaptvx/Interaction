		...
		do -- Theme
			local function UpdateTheme()
				if (theme and theme == 2) or (not theme and addon.API.Util.IsDarkTheme) then
					frame._DefaultTexture = frame._CustomDefaultTexture or (addon.Variables.PATH_ART .. "Elements\\Elements\\SliderBackground.png")
					frame._HighlightTexture = frame._CustomHighlightTexture or (addon.Variables.PATH_ART .. "Elements\\Elements\\SliderBackgroundHighlighted.png")
					frame._ThumbTexture = frame._CustomThumbTexture or (addon.Variables.PATH_ART .. "Elements\\Elements\\SliderThumb.png")
					frame._ThumbHighlightTexture = frame._ThumbHighlightTexture or (addon.Variables.PATH_ART .. "Elements\\Elements\\SliderThumbHighlighted.png")
