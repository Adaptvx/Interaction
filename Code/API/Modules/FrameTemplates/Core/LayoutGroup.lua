            ...
            if direction == "horizontal" then
                ...
                do -- Elements
                    ...
                    for i = 1, #rowInfo do
                        ...
                        for rowIndex = 1, #rowElements do
                            local element = rowElements[rowIndex]
                            local nextElement = rowElements[rowIndex + 1] or nil
                            ...
                            local isOverflow = ((newOffsetX + nextElementWidth) >= containerWidth)
                            local isLastElementInRow = (rowIndex == #rowElements)
