		...
		do -- CLICK EVENTS
			Frame.Enter = function()
				...
				if isHorizontal then
					addon.API.Animation:Scale(Frame.Thumb, .5, Frame.Thumb:GetHeight(), Frame:GetHeight() * 2, "y", addon.API.Animation.EaseExpo, function() return not Frame.MouseOver end)
				else
					addon.API.Animation:Scale(Frame.Thumb, .5, Frame.Thumb:GetWidth(), Frame:GetWidth() * 2, "x", addon.API.Animation.EaseExpo, function() return not Frame.MouseOver end)
				end
			end
			...
			Frame.Leave = function()
				...
				if isHorizontal then
					addon.API.Animation:Scale(Frame.Thumb, .5, Frame.Thumb:GetHeight(), Frame:GetHeight(), "y", addon.API.Animation.EaseExpo, function() return Frame.MouseOver end)
				else
					addon.API.Animation:Scale(Frame.Thumb, .5, Frame.Thumb:GetWidth(), Frame:GetWidth(), "x", addon.API.Animation.EaseExpo, function() return Frame.MouseOver end)
				end
			end
