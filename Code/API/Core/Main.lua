...
do -- Platform
	function addon.API.Main:SetButtonToPlatform(frame, textFrame, keybindVariable, height, padding, paddingWidth)
		...
		if not Frame then
			...
			Frame.KeybindFrame.Background, Frame.KeybindFrame.BackgroundTexture = addon.API.FrameTemplates:CreateNineSlice(Frame.KeybindFrame, frameStrata, addon.Variables.PATH_ART .. "Platform\\KeybindBackground.png", 128, .125, "$parent.Background")
			...
			local function UpdateFormatting()
				if #frame.API_ButtonTextFrame_Variables.keybindVariable >= 1 then
					...
					local replaceWithImageList = {
						SPACE = addon.Variables.PATH_ART .. "Platform\\Text-PC-Space.png",
						PAD1 = IsPlaystation and addon.Variables.PATH_ART .. "Platform\\PS-1.png" or IsXbox and addon.Variables.PATH_ART .. "Platform\\XBOX-1.png",
						PAD2 = IsPlaystation and addon.Variables.PATH_ART .. "Platform\\PS-2.png" or IsXbox and addon.Variables.PATH_ART .. "Platform\\XBOX-2.png",
						PAD3 = IsPlaystation and addon.Variables.PATH_ART .. "Platform\\PS-3.png" or IsXbox and addon.Variables.PATH_ART .. "Platform\\XBOX-3.png",
						PAD4 = IsPlaystation and addon.Variables.PATH_ART .. "Platform\\PS-4.png" or IsXbox and addon.Variables.PATH_ART .. "Platform\\XBOX-4.png",
						PADLSHOULDER = addon.Variables.PATH_ART .. "Platform\\LB.png",
						PADRSHOULDER = addon.Variables.PATH_ART .. "Platform\\RB.png",
						PADLTRIGGER = addon.Variables.PATH_ART .. "Platform\\LT.png",
						PADRTRIGGER = addon.Variables.PATH_ART .. "Platform\\RT.png",
					}
